...
1. [Usage](#usage)
    1. [CLI](#cli)
        ...
        3. [Setting up a new shapez.io mod](#setting-up-a-new-shapezio-mod)
        4. [Updating shapez.io typings](#updating-shapezio-typings)
...
- [nodejs >= 16.0.0 < 17.0.0](#installing-nodejs)
